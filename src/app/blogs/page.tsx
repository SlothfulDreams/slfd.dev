          ...
          <div className="terminal-content">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <p className="mb-2">
                  drwxr-xr-x 2 slothy staff 64 Aug 30 23:21 .
                </p>
                <p className="mb-4">
                  drwxr-xr-x 3 slothy staff 96 Aug 30 23:21 ..
                </p>
              </motion.div>
              ...
              >
                <div className="text-[#A7B7A7] mb-4">
                  <span className="text-[#758B80]">$</span> echo "No posts
                  found... yet!"
                </div>
              ...
              >
                <p className="mb-3">
                  <span className="text-[#758B80]">→</span> Brewing fresh
                  content
                </p>
                <p className="mb-3">
