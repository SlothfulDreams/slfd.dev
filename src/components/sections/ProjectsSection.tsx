        ...
        {projects.map((project) => (
          ...
          >
            <div className="flex items-start justify-between mb-1">
              <h3 className="text-sm font-medium text-[var(--color-on-surface)] group-hover:text-[var(--color-primary)]">
                {project.name}
              </h3>
            ...
            {project.description && (
              <p className="text-xs text-[var(--color-on-surface-variant)] leading-relaxed mb-2">
                {project.description}
              </p>
            )}
            {project.video && (
